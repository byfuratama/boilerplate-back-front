      ...
      <q-tr :props="props">
        <q-td v-for="col in props.cols" :key="col.name" :props="props">
          ...
          <template v-else-if="col.type === 'date'">
            <input-date  :placeholder="col.label" v-model="props.row[col.name]" v-bind="col.attr"/>
          </template>
          <template v-else-if="col.type === 'time'">
            <input-time  :placeholder="col.label" v-model="props.row[col.name]" v-bind="col.attr"/>
          </template>
